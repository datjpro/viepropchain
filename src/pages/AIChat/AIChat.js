...
const AIChat = () => {
  ...
  const generateAIResponse = (userInput) => {
    ...
    if (
      input.includes("đầu tư") ||
      input.includes("lợi nhuận") ||
      input.includes("tiềm năng")
    ) {
    ...
    if (
      input.includes("phân tích") ||
      input.includes("thị trường") ||
      input.includes("xu hướng")
    ) {
    ...
    if (
      ...
      input.includes("chuyên gia") ||
      input.includes("tư vấn")
    ) {
